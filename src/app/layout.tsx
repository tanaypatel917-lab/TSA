...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`${clash.variable} ${uncut.variable}`}><body><a href="#main" className="skip-link">Skip to content</a><MotionProvider><RevealObserver /><TypeField /><PageTransitions /><ProgressProvider><SiteNav /><IntroGate /><main id="main" tabIndex={-1}>{children}</main><BadgeToast /><SiteFooter /></ProgressProvider></MotionProvider></body></html>;
}
