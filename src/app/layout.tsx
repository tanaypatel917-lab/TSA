...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" style={{ "--font-display": "\"Instrument Serif\"", "--font-sans": "\"Inter Tight Variable\"", "--font-mono": "\"JetBrains Mono Variable\"" } as React.CSSProperties}><body>
    ...
    <ProgressProvider>
      ...
      <footer className="mt-24 border-t border-line bg-paper"><div className="shell pt-16"><p className="font-display text-[14vw] leading-[.7] tracking-[-.05em] text-ink/65">AI Compass</p><div className="mt-12 flex flex-col gap-3 border-t border-line py-6 font-mono text-[10px] uppercase tracking-[0.16em] text-ink/60 sm:flex-row sm:justify-between"><span>Learn with curiosity and care.</span><span>Local-first · No tracking · Grades 9–12</span></div></div></footer>
    </ProgressProvider>
  </body></html>;
}
