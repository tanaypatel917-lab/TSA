...
export type IntroAct = { id: IntroActId; label: string; background: string; tone: IntroTone; layout: IntroLayout; title: string; lines?: [string, string]; text: string; teaser?: string };

export const introActs: IntroAct[] = [
  { id: "start", label: "Start", background: introPalette.ink, tone: "dark", layout: "hero", title: "Follow the question.", text: "Six short scenes about how AI turns your words into answers, where it slips, and why your judgment still matters." },
  { id: "questions", label: "Questions", background: introPalette.ink, tone: "dark", layout: "right", teaser: "Bring your own question", title: "It starts with a question.", text: "AI gets less mysterious once you stop treating it like magic. Every answer it gives, right or wrong, starts with a question. Bring yours along." },
  { id: "inside", label: "Inside", background: introPalette.slate, tone: "dark", layout: "left", teaser: "Watch words turn into a map", title: "Words become places.", text: "How does a model know which words go together? Scroll through four quick steps." },
  { id: "prompts", label: "Prompts", background: introPalette.sky, tone: "light", layout: "right", teaser: "Build a better prompt", title: "Better words make better tools.", text: "A prompt is a set of instructions, not a spell. Add the parts and watch a vague request turn into a useful one." },
  { id: "proof", label: "Proof", background: introPalette.paper, tone: "light", layout: "left", teaser: "Catch a confident mistake", title: "Confidence is not proof.", text: "AI can sound certain and still be wrong. The habit that helps is simple: check the claim before you repeat it." },
  { id: "practice", label: "Practice", background: introPalette.ink, tone: "dark", layout: "right", teaser: "Break it, then fix it", title: "Try it. Break it. Improve it.", text: "Short activities turn ideas into habits: sort examples, rewrite prompts, weigh choices, and build a final project." },
  { id: "finale", label: "Your turn", background: introPalette.clay, tone: "light", layout: "center", teaser: "Find where to start", title: "Ask better. Think further.", lines: ["Ask better.", "Think further."], text: "Your progress stays on this device. The lessons, activities, and quizzes are ready when you are." }
];
