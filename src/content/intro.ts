export const introPalette = { ink: "#351B2B", rose: "#EF99AC", paper: "#F9F2E9", citron: "#D8E96B", plum: "#8C4A6B", berry: "#C65D7E" } as const;
...
export const introActs: IntroAct[] = [
  ...
  { id: "examples", label: "Examples", background: introPalette.rose, tone: "light", layout: "left", title: "Examples shape the answer.", text: "Models learn patterns from examples. Narrow examples produce narrow answers, and a model cannot tell you what it never saw." },
  { id: "prompts", label: "Prompts", background: introPalette.citron, tone: "light", layout: "right", title: "Better words make better tools.", text: "A prompt is a set of instructions, not a spell. Add the parts and watch a vague request turn into a useful one." },
  ...
  { id: "finale", label: "Your turn", background: introPalette.rose, tone: "light", layout: "center", title: "Ask better. Think further.", lines: ["Ask better.", "Think further."], text: "Your progress stays on this device. The lessons, activities, and quizzes are ready when you are." }
];

export const introQuestions = ["Is this true?", "Who made this?", "What is missing?", "Who does it affect?", "Can I check it?"];

export const introWallColors = [introPalette.ink, introPalette.paper, introPalette.citron, introPalette.plum];
...
export const introPromptParts: IntroPromptPart[] = [
  { id: "role", label: "Role", sentence: "Act as a biology tutor.", hint: "Add a role so the tone fits the job.", color: introPalette.rose, tokens: 4 },
  ...
  { id: "format", label: "Format", sentence: "Use five numbered steps.", hint: "Add a format so the answer is easy to use.", color: introPalette.plum, tokens: 4 },
  { id: "constraints", label: "Constraints", sentence: "Keep it under 120 words.", hint: "Add constraints so it stays focused.", color: introPalette.berry, tokens: 5 }
];
