...
export const introActs: IntroAct[] = [
  ...
  { id: "inside", label: "Inside", background: introPalette.slate, tone: "dark", layout: "left", title: "Words become places.", text: "Inside a language model, every word gets a spot on a map, and words used in similar ways sit close together. Watch where your words land." },
