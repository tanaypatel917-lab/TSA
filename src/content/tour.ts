...
export const tourStops: TourStop[] = [
  ...
  { path: "/modules/ai-foundations/lessons/data-and-bias/", target: ".lab", title: "Lessons you can poke at", text: "Key lessons include a hands-on tool. Here, a real tiny model trained in your browser shows how one-sided training data makes it fail one group. Underlined terms explain themselves, and every lesson cites its sources." },
