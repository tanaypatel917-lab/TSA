...
export function Cursor() {
  useEffect(() => {
    ...
    const over = (event: MouseEvent) => {
      ...
      const open = Boolean(target.closest("[data-cursor='open']"));
      ring.classList.toggle("cursor-open", open);
      ring.classList.toggle("cursor-hover", !open && Boolean(target.closest("[data-cursor='hover'],a,button")));
    };
